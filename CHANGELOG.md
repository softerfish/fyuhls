...
- Added cURL fallbacks and admin diagnostics for GitHub release checks and update archive downloads when PHP stream URL access is unavailable or unreliable.
