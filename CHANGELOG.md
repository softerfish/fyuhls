...
- Added cURL fallbacks, GitHub API-compatible archive headers, and admin diagnostics for release checks and update downloads when PHP stream URL access is unavailable or unreliable.
