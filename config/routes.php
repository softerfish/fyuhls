...
use App\Controller\Admin\SiteContentController;
...
$router->get('/tickets/{id}', [TicketController::class, 'index']);
$router->post('/tickets/create', [TicketController::class, 'create']);
$router->post('/tickets/reply/{id}', [TicketController::class, 'reply']);
$router->post('/tickets/close/{id}', [TicketController::class, 'close']);
...
$router->get('/admin/site-content', [SiteContentController::class, 'index']);
$router->post('/admin/site-content/save', [SiteContentController::class, 'save']);
$router->post('/admin/site-content/preview', [SiteContentController::class, 'preview']);
