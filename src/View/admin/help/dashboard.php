<div class="p-1">
    ...
    <ul class="extra-small text-muted mb-4">
        <li class="mb-2"><strong>Cache Status:</strong> <em>Optimized</em> means the dashboard is using cached summary stats. <em>Warming Up</em> usually appears right after install or refresh while the first summary cache is being created. <em>Live Fallback</em> means the cache is degraded and the dashboard is using live database totals until the stats refresh succeeds.</li>
