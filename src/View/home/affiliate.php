...
<style>
    ...
    .affiliate-tier-section { margin-top: 3.75rem; }
    ...
    .program-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(min(100%, 300px), 1fr)); gap: 1rem; align-items: stretch; }
    ...
    .program-card p { line-height: 1.55; color: #4b5563; margin-bottom: 0.9rem; font-size: 0.92rem; max-width: 38ch; }
    ...
    <div class="fm-main affiliate-main">
        <div class="fm-toolbar">
            <div class="toolbar-left">
                <h2 class="folder-title">Affiliate Program</h2>
            ...
            <div class="toolbar-right">
                <div class="toolbar-controls">
                    <span class="affiliate-toolbar-note">Choose your earning model, review live PPD tiers, and manage the referral link tied to your account.</span>
                </div>
            </div>
        </div>
...
<?php else: ?>
<div class="affiliate-section" style="padding-top: 4rem;">
